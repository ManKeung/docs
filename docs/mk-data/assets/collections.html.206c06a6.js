import{_ as n,o as s,c as a,a as t}from"./app.7b8ed854.js";const e={},p=t(`<h1 id="\u534F\u7A0B" tabindex="-1"><a class="header-anchor" href="#\u534F\u7A0B" aria-hidden="true">#</a> \u534F\u7A0B</h1><ul><li>\u81EA\u5DF1\u5B9E\u73B0\u4E00\u4E2A\u53EF\u4EE5\u8FED\u4EE3\u7684\u5BF9\u8C61</li></ul><div class="language-python ext-py line-numbers-mode"><pre class="language-python"><code><span class="token keyword">from</span> collections<span class="token punctuation">.</span>abc <span class="token keyword">import</span> Iterable
