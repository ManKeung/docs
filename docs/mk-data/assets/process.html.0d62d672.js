import{_ as n,o as s,c as a,a as p}from"./app.fe9eae39.js";const t={},e=p(`<h1 id="\u8FDB\u7A0B" tabindex="-1"><a class="header-anchor" href="#\u8FDB\u7A0B" aria-hidden="true">#</a> \u8FDB\u7A0B</h1><ul><li>\u4F7F\u7528\u8FDB\u7A0B</li></ul><div class="language-python ext-py line-numbers-mode"><pre class="language-python"><code><span class="token keyword">import</span> time
