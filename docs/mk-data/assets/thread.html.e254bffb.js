import{_ as n,o as s,c as a,a as t}from"./app.c5a3bfa0.js";const p={},e=t(`<h1 id="\u7EBF\u7A0B" tabindex="-1"><a class="header-anchor" href="#\u7EBF\u7A0B" aria-hidden="true">#</a> \u7EBF\u7A0B</h1><ul><li>\u57FA\u672C\u7528\u6CD5</li></ul><div class="language-python ext-py line-numbers-mode"><pre class="language-python"><code><span class="token keyword">import</span> time
