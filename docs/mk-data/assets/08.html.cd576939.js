import{_ as n,o as s,c as a,a as e}from"./app.60f11e6a.js";const t={},p=e(`<h1 id="class\u7C7B" tabindex="-1"><a class="header-anchor" href="#class\u7C7B" aria-hidden="true">#</a> Class\u7C7B</h1><p>es6</p><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
