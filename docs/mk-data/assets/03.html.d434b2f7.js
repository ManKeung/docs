import{_ as n,o as s,c as e,a as i}from"./app.f2f55b37.js";const a={},l=i(`<h1 id="nginx\u914D\u7F6E\u53C2\u6570\u8BF4\u660E" tabindex="-1"><a class="header-anchor" href="#nginx\u914D\u7F6E\u53C2\u6570\u8BF4\u660E" aria-hidden="true">#</a> Nginx\u914D\u7F6E\u53C2\u6570\u8BF4\u660E</h1><div class="language-ini ext-ini line-numbers-mode"><pre class="language-ini"><code><span class="token comment">#\u5B9A\u4E49Nginx\u8FD0\u884C\u7684\u7528\u6237\u548C\u7528\u6237\u7EC4</span>
user www www;
...
$ <span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /opt/html
...
$ <span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token number">6666</span>:80 <span class="token parameter variable">--name</span> nginx-node1 <span class="token parameter variable">-v</span> /opt/html:/usr/share/nginx/html <span class="token parameter variable">--restart</span> always nginx
...
$ <span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token number">6666</span>:80 <span class="token parameter variable">--name</span> nginx-node2 <span class="token parameter variable">-v</span> <span class="token variable"><span class="token variable">$(</span><span class="token builtin class-name">pwd</span><span class="token variable">)</span></span>/html:/usr/share/nginx/html <span class="token parameter variable">--restart</span> always nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>\u6D4B\u8BD5</li></ul><p>\u57DF\u540D:mongo.demo.com\uFF0C\u8FD9\u91CC\u662F\u7528Windows\u7CFB\u7EDF\u4E3B\u673A\u8BBF\u95EE\u670D\u52A1\u5668\uFF0C\u8981\u5728\u5F53\u524D\u4E3B\u673A\u7684hosts\u4E2D\u6DFB\u52A0\u89E3\u6790 \u201Cmongo.demo.com 192.168.0.4\u201D\uFF0Chosts\u6587\u4EF6\u6240\u5728\u7684\u8DEF\u5F84\u4E3A \u201CC:\\Windows\\System32\\drivers\\etc\u201D\u3002\u8FD9\u91CC\u5728Windows\u4E3B\u673A\u4E0A\u901A\u8FC7\u6D4F\u89C8\u5668\u8BBF\u95EE \u201Chttp://mongo.demo.com:8888\u201D \u8FD9\u4E2A\u7AD9\u70B9\u7684\u65F6\u5019\uFF0CNginx\u4F1A\u6839\u636E\u6765\u8BBF\u7684\u4E3B\u673A\u7684ip_hash\u503C\uFF0C\u8D1F\u8F7D\u5747\u8861\u5230192.168.0.5\uFF08Nginx-Node1/Nginx-Web1\uFF09\u548C192.168.0.7\uFF08Nginx-Node2/Nginx-Web2\uFF09\u670D\u52A1\u5668\u4E0A\u3002\u5982\u679C\u5176\u4E2D\u4E00\u4E2AWeb\u670D\u52A1\u5668\u65E0\u6548\u540E\uFF0C\u8D1F\u8F7D\u5747\u8861\u670D\u52A1\u5668\u4F1A\u81EA\u52A8\u5C06\u8BF7\u6C42\u8F6C\u53D1\u5230\u6B63\u5E38\u7684Web\u670D\u52A1\u5668\u3002</p>`,19),d=[l];function r(v,c){return s(),e("div",null,d)}const m=n(a,[["render",r],["__file","03.html.vue"]]);export{m as default};
